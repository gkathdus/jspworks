   ...
   <form action="joinProcess.jsp" method="post">
      <ul>
         ...
         <li>
            ...
            <input type="checkbox" id="hobby" name="hobby" value="장원영 보기" >장원영 보기
            <input type="checkbox" id="hobby" name="hobby" value="윈터 페이스캠 보기" >윈터 페이스캠 보기
            <input type="checkbox" id="hobby" name="hobby" value="정국 입덕직캠 보기" checked>정국 입덕직캠 보기
         </li>
         <li>
